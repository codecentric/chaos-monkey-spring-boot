...
* Please make sure to run the tests before you commit your changes. Using Maven you can run `./mvnw test` which will run all tests when you run the command in the root folder of the repository.
