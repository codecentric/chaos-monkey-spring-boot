...
If you want chaos monkey to attack your classes they need to be open (=non-final). If you're using java, this is the default. Just don't mark your classes or methods as final. If you're using kotlin, we recommend using the kotlin spring plugin:
