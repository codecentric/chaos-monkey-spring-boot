...
If you want chaos monkey to attack your classes they need to be open (=non-final). If you're using Java, this is the default. Just don't mark your classes or methods as final. If you're using Kotlin, we recommend using the https://kotlinlang.org/docs/all-open-plugin.html#spring-support[Kotlin Spring plugin], which automatically opens Spring annotated classes for you:
