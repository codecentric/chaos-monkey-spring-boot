...
CAUTION: Each Chaos Monkey version is built for a specific Spring Boot version. If you're using a different Spring Boot version in your application, Chaos Monkey might not work.
